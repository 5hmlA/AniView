...
public class RotatablePie extends FreeLine {
	...
	public RotatablePie(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	public RotatablePie(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public RotatablePie(Context context) {
		super(context);
	}
...
//				}
	...
	public class eachPie {
		...
		public eachPie(String describe, Float num, int pieColor, float startAngle,
				float sweepAngle) {
			super();
